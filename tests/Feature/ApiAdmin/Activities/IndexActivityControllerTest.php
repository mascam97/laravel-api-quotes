...
test('sql queries optimization test', function () {
    ...
    expect(formatQueries(DB::getQueryLog()))
        ...
        ->sequence(
            ...
            fn ($query) => $query->toBe('select `id`, `log_name`, `description`, `subject_type`, `subject_id`, `causer_type`, `causer_id`, `event`, `created_at`, `updated_at` from `activity_log` limit 15 offset 0'),
